...
--
CREATE DATABASE IF NOT EXISTS `ecommerceweb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `ecommerceweb`;
...
--
ALTER TABLE `tbl_color`
  MODIFY `color_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `tbl_rating`
  MODIFY `rt_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_shipping_cost`
  MODIFY `shipping_cost_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_size`
  MODIFY `size_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `tbl_subscriber`
  MODIFY `subs_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
